...
const Settings = () => {
  const [tags, setTags] = useState([
    ...
    },
    {
      ...
      name: "Follow-Up",
      color: "#FF9800",
      description: "Emails that need follow-up",
    },
    {
      id: 3,
      name: "Work",
        ...
        >
          ...
          <Card sx={{ mb: 4 }}>
            <CardContent>
              ...
              >
                <Typography variant="h6">Email Tags</Typography>
                <Button
                  variant="contained"
                  startIcon={<AddIcon />}
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                Create and manage custom tags to organize your emails. Tags help
                with automatic classification and filtering.
              </Typography>
