  ...
  return (
    <Box sx={{ display: "flex", height: "100vh" }}>
      ...
      <Box sx={{ flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        <Box
          sx={{ flex: 1, p: 3, backgroundColor: "#F8F9FA", overflow: "auto" }}
        >
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>
            Manage your privacy settings and data consent preferences. Your
          ...
          >
            <Typography variant="body1" sx={{ fontWeight: 600 }}>
              ⚠️ This is a mockup. Changes are not persisted.
            </Typography>
          </Box>
                  ...
                  label={
                    <Box>
                      ...
                      <Typography variant="caption" color="text.secondary">
                        Allow AI analysis of email content for insights and
                        summaries
                      </Typography>
                    </Box>
                  }
                ...
                <FormControlLabel
                  ...
                  label={
                    <Box>
                      ...
                      <Typography variant="caption" color="text.secondary">
                        Store processed data in secure cloud storage for faster
                        access
                      </Typography>
                    </Box>
                  }
                ...
                <FormControlLabel
                  ...
                  label={
                    <Box>
                      ...
                      <Typography variant="caption" color="text.secondary">
                        Allow integration with external services for enhanced
                        features
                      </Typography>
                    </Box>
                  }
        ...
        <DialogContent>
          {dialogType === "delete" && (
            <Typography>
              ...
              be undone. All your emails, settings, and processed data will be
              permanently removed.
            </Typography>
          )}
          {dialogType === "export" && (
            <Typography>
              Your data export will be prepared and sent to your registered
              email address within 24 hours. The export will include all your
              processed emails, settings, and analytics data in a secure format.
            </Typography>
          )}
          {dialogType === "privacy" && (
            <Box>
